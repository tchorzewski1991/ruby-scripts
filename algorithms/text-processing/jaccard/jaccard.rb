module Jaccard
  module Words
    ...
    def self.coefficient(origin, target, round: DEFAULT_ROUND)
      # Variables o_codepoints, and t_codepoints are self explanatory.
      # As It turns out, there is no need for iteration at all. The only
      # thing that need to be done is to produce intersection and union
